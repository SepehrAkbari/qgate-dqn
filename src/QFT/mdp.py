...
class QuantumOperatorCircuitEnv:
    def __init__(self, n_qubits, target_unitary, possible_actions, REWARD_GATE_PENALTY, REWARD_SUCCESS, FIDELITY_THRESHOLD, REWARD_FIDELITY_WEIGHT, max_gates=20):
        '''
